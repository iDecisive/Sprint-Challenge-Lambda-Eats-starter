...
“useRouteMatch” may be used for getting URL parameters.

2. How would you explain form validation to someone who has never programmed before?

Validation can be used for ensuring information the user has typed is in the correct format. For example, an email needing the @ symbol.

3. In 1-2 sentences, define end to end testing.

End to end testing is testing the entire use experience on a website using software like Cypress to ensure everything works as intended.
